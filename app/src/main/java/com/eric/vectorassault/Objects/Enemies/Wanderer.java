...
public class Wanderer extends EnemyObject
   {

      private Texture texture;


      public Wanderer(Context context, int levelNumber, int mapWidth, int mapHeight)
         {
            super();
            ...
            texture = new Texture(context, R.drawable.wander_glow3);
